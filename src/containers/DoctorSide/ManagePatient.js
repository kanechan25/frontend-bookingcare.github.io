...
import { getAllPatientForDoctorService, sendPrescriptionService } from '../../services/userService';
            ...
            >
                <div className="patient-container container">
                    ...
                    <div className='form-group col-sm-5 col-12'>
                        <label className='mt-3'><FormattedMessage id="doctorpatient.label-date" /></label>
                        <DatePicker
