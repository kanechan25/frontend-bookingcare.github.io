...
class ManageDoctor extends Component {
    ...
    handleClickEditDoctorRedux = (user) => {
        alert('You click to EDIT Doctor')
    };

    handleClickDeleteDoctorRedux = (user) => {
        alert('You click to DELETE Doctor')
    ...
    render() {
        ...
        return (
            <div className='doctor-management'>
                ...
                <MdEditor style={{ height: '500px', marginBottom: '50px' }} 
                    renderHTML={text => mdParser.render(text)} onChange={this.handleEditorChange}
                />
                <div className='container'>
                    <button
                        className='save btn btn-info col-xxl-1 col-xl-1 col-lg-1 col-md-2 col-sm-2 col-2'
