...
class ModalUser extends Component {
    ...
    checkValidateInput = () => {
        let isValid = true;
        let arrInput = [ 'email', 'password', 'lastName', 'firstName', 'address', 'phoneNum', 'gender', 'roleId' ];
                        ...
                        <div className="container">
                            <div className="row text-info">
                                <form className="mt-1" action="/post-crud" method="POST">
                                    ...
                                    <div className="form-group mt-3">
                                        <input type="text" className="form-control " name="address" placeholder="Enter address: etc. 2425, Vo Nguyen Giap St, HCMC" 
                                    ...
                                    <div className="form-row">
                                        <div className="form-group mt-3">
                                            <input type="text" className="form-control " name="phoneNum" placeholder="Enter phone number: etc. +84368889999 or 0986969696" 
