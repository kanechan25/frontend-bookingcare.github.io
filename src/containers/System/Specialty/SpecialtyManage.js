            ...
            <>
                <div className='manage-specialty-container'>
                    <div className='specialty-management'>
                        <div className="title" > <FormattedMessage id="system.managespecialty.headline" /></div>
                                ...
                                <div className='info-input col-md-7 col-12'>
                                    <div className='contain-left container'>
                                        <div className='namevi-specialty col-12'>
                                            <label className='mt-3 mb-1'><FormattedMessage id="system.managespecialty.namevi" /></label>
                                            <input
                                        ...
                                        <div className='nameen-specialty col-12'>
                                            <label className='mt-3 mb-1'><FormattedMessage id="system.managespecialty.nameen" /></label>
                                            <input
                                                className='form-control'
                                        ...
                                        <div className='img-specialty col-12'>
                                            <label className='mt-3 mb-1'><FormattedMessage id="system.managespecialty.img" /></label>
                                            <input
                                                className='form-control'
                                                value={image}
                        ...
                        <div className='detail-specialty container'>
                            <label className='mt-3 mb-1'><FormattedMessage id="system.managespecialty.description" /></label>
                            <MdEditor
