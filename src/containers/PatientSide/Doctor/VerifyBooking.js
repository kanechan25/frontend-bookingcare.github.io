            ...
            <>
                ...
                <div className='verify-booking container'>
                    {verifyStatus === false ?
                        ...
                        <div>
                            {+errCode === 0 ?
                                <div className='notice-text success'>Your booking has been verified!</div> :
                                <div className='notice-text fail'>Your booking has not existed or It was verified!</div>
                            }
                        </div>
                    }
                </div>
