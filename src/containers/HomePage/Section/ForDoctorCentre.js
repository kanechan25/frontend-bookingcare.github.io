                            ...
                            <Slider {...this.props.settings}>
                                <div className='slide'>
                                    <a className='slider-link' href=''>
                                        ...
                                        <span className='fordoctorcentre-title'><b><FormattedMessage id="fordoctorcentre.customerlifetimevalue"/></b></span>
                                    </a>  
                                </div>
                                <div className='slide'>
                                    <a className='slider-link' href=''>
                                        ...
                                        <span className='fordoctorcentre-title'><b><FormattedMessage id="fordoctorcentre.improvecustomerservice"/></b></span>
                                    </a>  
                                </div>
                                <div className='slide'>
                                    <a className='slider-link' href=''>
                                        <div className='slider'>
                                            <img className='img col' src={ upcustomerexperienceinwaitingroom } />
                                        </div>
                                        <span className='fordoctorcentre-title'><b><FormattedMessage id="fordoctorcentre.upcustomerexperienceinwaitingroom"/></b></span>
                                    </a>  
                                </div>
                                <div className='slide'>
                                    <a className='slider-link' href=''>
