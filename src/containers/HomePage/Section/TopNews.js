                            ...
                            <Slider {...this.props.settings}>
                                <div className='slide'>
                                    <a className='slider-link' href=''>
                                        ...
                                        <span className='slider-title'><b><FormattedMessage id="topnews.paternity"/></b></span>
                                        <ul>
                                            <li><FormattedMessage id="topnews.paternity1"/></li>
                                            <li><FormattedMessage id="topnews.paternity2"/></li>
                                            <li><FormattedMessage id="topnews.paternity3"/></li>
                                        </ul>
                                        <span className='expansion'><b><FormattedMessage id="topnews.more"/>
                                            <i className="fas fa-greater-than"></i></b>
                                        </span>
                                    </a>
                                </div>
                                <div className='slide'>
                                    <a className='slider-link' href=''>
                                        ...
                                        <span className='slider-title'><b><FormattedMessage id="topnews.counseling"/></b></span>
                                        <ul>
                                            <li><FormattedMessage id="topnews.counseling1"/></li>
                                            <li><FormattedMessage id="topnews.counseling2"/></li>
                                            <li><FormattedMessage id="topnews.counseling3"/></li>
                                        </ul>
                                        <span className='expansion'><b><FormattedMessage id="topnews.more"/>
                                            <i className="fas fa-greater-than"></i></b>
                                        </span>
                                ...
                                <div className='slide'>
                                    <a className='slider-link' href=''>
                                        ...
                                        <span className='slider-title'><b><FormattedMessage id="topnews.homedoctor"/></b></span>
                                        <ul>
                                            <li><FormattedMessage id="topnews.homedoctor1"/></li>
                                            <li><FormattedMessage id="topnews.homedoctor2"/></li>
                                            <li><FormattedMessage id="topnews.homedoctor3"/></li>
                                        </ul>
                                        <span className='expansion'><b><FormattedMessage id="topnews.more"/>
                                            <i className="fas fa-greater-than"></i></b>
                                        </span>
                                ...
                                <div className='slide'>
                                    <a className='slider-link' href=''>
                                        ...
                                        <span className='slider-title'><b><FormattedMessage id="topnews.sp02"/></b></span>
                                        <ul>
                                            <li><FormattedMessage id="topnews.sp021"/></li>
                                            <li><FormattedMessage id="topnews.sp022"/></li>
                                            <li><FormattedMessage id="topnews.sp023"/></li>
                                        </ul>
                                        <span className='expansion'><b><FormattedMessage id="topnews.more"/>
                                            <i className="fas fa-greater-than"></i></b>
                                        </span>
                                ...
                                <div className='slide'>
                                    <a className='slider-link' href=''>
                                        ...
                                        <span className='slider-title'><b><FormattedMessage id="topnews.testcovid"/></b></span>
                                        <ul>
                                            <li><FormattedMessage id="topnews.testcovid1"/></li>
                                            <li><FormattedMessage id="topnews.testcovid2"/></li>
                                            <li><FormattedMessage id="topnews.testcovid3"/></li>
                                        </ul>
                                        <span className='expansion'><b><FormattedMessage id="topnews.more"/>
                                            <i className="fas fa-greater-than"></i></b>
                                        </span>
